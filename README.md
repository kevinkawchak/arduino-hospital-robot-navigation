...
## RL Video: [arduino_hospital_robot_navigation_RL](https://drive.google.com/drive/folders/1leHVc8xvDDE-TO3S-0fI4KPEotgI-jy_?usp=sharing)
...
This project simulates a hospital delivery robot that autonomously navigates through a hospital environment, visiting multiple stations to pick up and deliver medical supplies. The robot demonstrates careful, measured movements appropriate for healthcare settings.
...
Created for hospital robotics research plus education demonstrations.
